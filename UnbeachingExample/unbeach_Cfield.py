...
datasetM = xr.open_dataset(data_path + 'domain/coordinates.nc', decode_cf=False)
datasetU = xr.open_dataset(data_path + 'means/ORCA0083-N06_20000105d05U.nc', decode_cf=False)
datasetV = xr.open_dataset(data_path + 'means/ORCA0083-N06_20000105d05V.nc', decode_cf=False)
