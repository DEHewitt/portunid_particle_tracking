...
setwd("C:/Users/htsch/Desktop/Snapper Crab/DD sensitivity/")
...
mydata <-readRDS("spanner_forwards_master_settled1400DD.rds")
...
write_csv(nsw_sum, "NSW DD Settlement 1400DD.csv")
