...
catch <- read_csv("QLD Catch.csv") %>% pivot_longer(2:8, names_to = "Region", values_to = "Catch_t")
effort <- read_csv("QLD Effort.csv") %>% pivot_longer(2:8, names_to = "Region", values_to = "Effort")
