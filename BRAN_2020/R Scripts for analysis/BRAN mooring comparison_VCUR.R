...
all_dat$Vel_BRAN_smooth = zoo::rollmean(all_dat$VCUR_BRAN, 7, fill=NA)
all_dat$Vel_Mooring_smooth = zoo::rollmean(all_dat$VCUR_Mooring, 7, fill=NA)
...
all_dat$KE_BRAN_smooth = zoo::rollmean(all_dat$VCUR_BRAN, 7, fill=NA)
all_dat$KE_Mooring_smooth = zoo::rollmean(all_dat$VCUR_Mooring, 7, fill=NA)
...
taylor.diagram(ref=all_dat_EAC2000$KE_Mooring_smooth, model = all_dat_EAC2000$KE_BRAN_smooth, normalize = F, pos.cor=F, add=F)
