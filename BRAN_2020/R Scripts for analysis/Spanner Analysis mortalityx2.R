...
mydata <- readRDS("Output/spanner_forwards_2_master_settled.rds")
...
ggsave("C:/Users/htsch/Desktop/Snapper Crab/Predicted v CPUE_Mort2.png", dpi=600, units="cm", height = 14.8, width=21)
ggsave("C:/Users/htsch/Desktop/Snapper Crab/Predicted v CPUE_Mort2.pdf", dpi=600, units="cm", height = 14.8, width=21)
...
ggsave("C:/Users/htsch/Desktop/Snapper Crab/Predicted v CPUE December spawning only_Mort2.png", dpi=600, units="cm", height = 14.8, width=21)
ggsave("C:/Users/htsch/Desktop/Snapper Crab/Predicted v CPUE December spawning only_mort2.pdf", dpi=600, units="cm", height = 14.8, width=21)
...
M2 <- full_dat_standardised_longX_Dec
