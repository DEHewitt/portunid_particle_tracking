...
#for product in products:
for year in years:
            url =("https://dapds00.nci.org.au/thredds/ncss/gb6/BRAN/BRAN2020/daily/ocean_"+product+"_"+str(year)+"_01.nc?var="+product+"&north=-10&west=140&east=165&south=-40&horizStride=1&time_start="+str(year)+"-01-01T12%3A00%3A00Z&time_end="+str(year)+"-01-31T12%3A00%3A00Z&timeStride=1&addLatLon=true")
            wget.download(url, '../../srv/scratch/z3374139/BRAN_AUS/Ocean_'+product+'_'+str(year)+'_01.nc')
...
#for product in products:
for year in years:
            url =("https://dapds00.nci.org.au/thredds/ncss/gb6/BRAN/BRAN2020/daily/ocean_"+product+"_"+str(year)+"_03.nc?var="+product+"&north=-10&west=140&east=165&south=-40&horizStride=1&time_start="+str(year)+"-03-01T12%3A00%3A00Z&time_end="+str(year)+"-03-31T12%3A00%3A00Z&timeStride=1&addLatLon=true")
            wget.download(url, '../../srv/scratch/z3374139/BRAN_AUS/Ocean_'+product+'_'+str(year)+'_03.nc')
...
#for product in products:
for year in years:
            url =("https://dapds00.nci.org.au/thredds/ncss/gb6/BRAN/BRAN2020/daily/ocean_"+product+"_"+str(year)+"_04.nc?var="+product+"&north=-10&west=140&east=165&south=-40&horizStride=1&time_start="+str(year)+"-04-01T12%3A00%3A00Z&time_end="+str(year)+"-04-30T12%3A00%3A00Z&timeStride=1&addLatLon=true")
            wget.download(url, '../../srv/scratch/z3374139/BRAN_AUS/Ocean_'+product+'_'+str(year)+'_04.nc')
...
#for product in products:
for year in years:
            url =("https://dapds00.nci.org.au/thredds/ncss/gb6/BRAN/BRAN2020/daily/ocean_"+product+"_"+str(year)+"_05.nc?var="+product+"&north=-10&west=140&east=165&south=-40&horizStride=1&time_start="+str(year)+"-05-01T12%3A00%3A00Z&time_end="+str(year)+"-05-31T12%3A00%3A00Z&timeStride=1&addLatLon=true")
            wget.download(url, '../../srv/scratch/z3374139/BRAN_AUS/Ocean_'+product+'_'+str(year)+'_05.nc')
...
#for product in products:
for year in years:
            url =("https://dapds00.nci.org.au/thredds/ncss/gb6/BRAN/BRAN2020/daily/ocean_"+product+"_"+str(year)+"_06.nc?var="+product+"&north=-10&west=140&east=165&south=-40&horizStride=1&time_start="+str(year)+"-06-01T12%3A00%3A00Z&time_end="+str(year)+"-06-30T12%3A00%3A00Z&timeStride=1&addLatLon=true")
            wget.download(url, '../../srv/scratch/z3374139/BRAN_AUS/Ocean_'+product+'_'+str(year)+'_06.nc')
...
#for product in products:
for year in years:
            url =("https://dapds00.nci.org.au/thredds/ncss/gb6/BRAN/BRAN2020/daily/ocean_"+product+"_"+str(year)+"_07.nc?var="+product+"&north=-10&west=140&east=165&south=-40&horizStride=1&time_start="+str(year)+"-07-01T12%3A00%3A00Z&time_end="+str(year)+"-07-31T12%3A00%3A00Z&timeStride=1&addLatLon=true")
            wget.download(url, '../../srv/scratch/z3374139/BRAN_AUS/Ocean_'+product+'_'+str(year)+'_07.nc')
...
#for product in products:
for year in years:
            url =("https://dapds00.nci.org.au/thredds/ncss/gb6/BRAN/BRAN2020/daily/ocean_"+product+"_"+str(year)+"_08.nc?var="+product+"&north=-10&west=140&east=165&south=-40&horizStride=1&time_start="+str(year)+"-08-01T12%3A00%3A00Z&time_end="+str(year)+"-08-31T12%3A00%3A00Z&timeStride=1&addLatLon=true")
            wget.download(url, '../../srv/scratch/z3374139/BRAN_AUS/Ocean_'+product+'_'+str(year)+'_08.nc')
...
#for product in products:
for year in years:
            url =("https://dapds00.nci.org.au/thredds/ncss/gb6/BRAN/BRAN2020/daily/ocean_"+product+"_"+str(year)+"_09.nc?var="+product+"&north=-10&west=140&east=165&south=-40&horizStride=1&time_start="+str(year)+"-09-01T12%3A00%3A00Z&time_end="+str(year)+"-09-30T12%3A00%3A00Z&timeStride=1&addLatLon=true")
            wget.download(url, '../../srv/scratch/z3374139/BRAN_AUS/Ocean_'+product+'_'+str(year)+'_09.nc')
...
#for product in products:
for year in years:
            url =("https://dapds00.nci.org.au/thredds/ncss/gb6/BRAN/BRAN2020/daily/ocean_"+product+"_"+str(year)+"_10.nc?var="+product+"&north=-10&west=140&east=165&south=-40&horizStride=1&time_start="+str(year)+"-10-01T12%3A00%3A00Z&time_end="+str(year)+"-10-31T12%3A00%3A00Z&timeStride=1&addLatLon=true")
            wget.download(url, '../../srv/scratch/z3374139/BRAN_AUS/Ocean_'+product+'_'+str(year)+'_10.nc')
...
#for product in products:
for year in years:
            url =("https://dapds00.nci.org.au/thredds/ncss/gb6/BRAN/BRAN2020/daily/ocean_"+product+"_"+str(year)+"_11.nc?var="+product+"&north=-10&west=140&east=165&south=-40&horizStride=1&time_start="+str(year)+"-11-01T12%3A00%3A00Z&time_end="+str(year)+"-11-30T12%3A00%3A00Z&timeStride=1&addLatLon=true")
            wget.download(url, '../../srv/scratch/z3374139/BRAN_AUS/Ocean_'+product+'_'+str(year)+'_11.nc')
...
#for product in products:
for year in years:
            url =("https://dapds00.nci.org.au/thredds/ncss/gb6/BRAN/BRAN2020/daily/ocean_"+product+"_"+str(year)+"_12.nc?var="+product+"&north=-10&west=140&east=165&south=-40&horizStride=1&time_start="+str(year)+"-12-01T12%3A00%3A00Z&time_end="+str(year)+"-12-31T12%3A00%3A00Z&timeStride=1&addLatLon=true")
            wget.download(url, '../../srv/scratch/z3374139/BRAN_AUS/Ocean_'+product+'_'+str(year)+'_12.nc')
...
#for product in products: # note changed year to years
for year in years:
             url =("https://dapds00.nci.org.au/thredds/ncss/gb6/BRAN/BRAN2020/daily/ocean_"+product+"_"+str(year)+"_02.nc?var="+product+"&north=-10&west=140&east=165&south=-40&horizStride=1&time_start="+str(year)+"-02-01T12%3A00%3A00Z&time_end="+str(year)+"-02-28T12%3A00%3A00Z&timeStride=1&addLatLon=true")
             wget.download(url, '../../srv/scratch/z3374139/BRAN_AUS/Ocean_'+product+'_'+str(year)+'_02.nc')
...
#for product in products:
for year in years:
            url =("https://dapds00.nci.org.au/thredds/ncss/gb6/BRAN/BRAN2020/daily/ocean_"+product+"_"+str(year)+"_02.nc?var="+product+"&north=-10&west=140&east=165&south=-40&horizStride=1&time_start="+str(year)+"-02-01T12%3A00%3A00Z&time_end="+str(year)+"-02-29T12%3A00%3A00Z&timeStride=1&addLatLon=true")
            wget.download(url, '../../srv/scratch/z3374139/BRAN_AUS/Ocean_'+product+'_'+str(year)+'_02.nc')
            #wget.download(url, '/Users/htsch/Documents/GitHub/portunid_particle_tracking/BRAN_2020/AUS/Ocean_'+product+'_'+str(years)+'_02.nc')
