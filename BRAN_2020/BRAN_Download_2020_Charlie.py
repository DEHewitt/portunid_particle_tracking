...
# Example
#url = 'https://dapds00.nci.org.au/thredds/ncss/gb6/BRAN/BRAN2020/daily/ocean_temp_2014_06.nc?var=temp&north=-8&west=142&east=161&south=-46&disableProjSubset=on&horizStride=1&time_start=2014-06-01T12%3A00%3A00Z&time_end=2014-06-30T12%3A00%3A00Z&timeStride=1&vertCoord=2.5&addLatLon=true'
#wget.download(url, '/Users/htsch/Documents/GitHub/portunid_particle_tracking/BRAN_2020/test_dloadC.nc')
...
#https://dapds00.nci.org.au/thredds/ncss/gb6/BRAN/BRAN2020/daily/ocean_temp_2014_06.nc?var=temp&north=-8&west=142&east=161&south=-46&disableProjSubset=on&horizStride=1&time_start=2014-06-01T12%3A00%3A00Z&time_end=2014-06-30T12%3A00%3A00Z&timeStride=1&vertCoord=2.5&addLatLon=true
...
#for product in products:
for year in years:
            url =("https://dapds00.nci.org.au/thredds/ncss/gb6/BRAN/BRAN2020/daily/ocean_"+product+"_"+str(year)+"_01.nc?var="+product+"&north=-8&west=142&east=161&south=-46&disableProjSubset=on&horizStride=1&time_start="+str(year)+"-01-01T12%3A00%3A00Z&time_end="+str(year)+"-01-31T12%3A00%3A00Z&timeStride=1&vertCoord=2.5&addLatLon=true")
            wget.download(url, '../../srv/scratch/z3374139/BRAN_AUS/Charlie/Ocean_'+product+'_'+str(year)+'_01.nc')
            #wget.download(url, '/Users/htsch/Documents/GitHub/portunid_particle_tracking/BRAN_2020/AUS/Ocean_'+product+'_'+str(year)+'_01.nc')
    
    
#  March
#for product in products:
for year in years:
            url =("https://dapds00.nci.org.au/thredds/ncss/gb6/BRAN/BRAN2020/daily/ocean_"+product+"_"+str(year)+"_03.nc?var="+product+"&north=-8&west=142&east=161&south=-46&disableProjSubset=on&horizStride=1&time_start="+str(year)+"-03-01T12%3A00%3A00Z&time_end="+str(year)+"-03-31T12%3A00%3A00Z&timeStride=1&vertCoord=2.5&addLatLon=true")
            wget.download(url, '../../srv/scratch/z3374139/BRAN_AUS/Charlie/Ocean_'+product+'_'+str(year)+'_03.nc')
            #wget.download(url, '/Users/htsch/Documents/GitHub/portunid_particle_tracking/BRAN_2020/AUS/Ocean_'+product+'_'+str(years)+'_03.nc')
    
# April
#for product in products:
for year in years:
            url =("https://dapds00.nci.org.au/thredds/ncss/gb6/BRAN/BRAN2020/daily/ocean_"+product+"_"+str(year)+"_04.nc?var="+product+"&north=-8&west=142&east=161&south=-46&disableProjSubset=on&horizStride=1&time_start="+str(year)+"-04-01T12%3A00%3A00Z&time_end="+str(year)+"-04-30T12%3A00%3A00Z&timeStride=1&vertCoord=2.5&addLatLon=true")
            wget.download(url, '../../srv/scratch/z3374139/BRAN_AUS/Charlie/Ocean_'+product+'_'+str(year)+'_04.nc')
            #wget.download(url, '/Users/htsch/Documents/GitHub/portunid_particle_tracking/BRAN_2020/AUS/Ocean_'+product+'_'+str(years)+'_04.nc')
    
# May
#for product in products:
for year in years:
            url =("https://dapds00.nci.org.au/thredds/ncss/gb6/BRAN/BRAN2020/daily/ocean_"+product+"_"+str(year)+"_05.nc?var="+product+"&north=-8&west=142&east=161&south=-46&disableProjSubset=on&horizStride=1&time_start="+str(year)+"-05-01T12%3A00%3A00Z&time_end="+str(year)+"-05-31T12%3A00%3A00Z&timeStride=1&vertCoord=2.5&addLatLon=true")
            wget.download(url, '../../srv/scratch/z3374139/BRAN_AUS/Charlie/Ocean_'+product+'_'+str(year)+'_05.nc')
            #wget.download(url, '/Users/htsch/Documents/GitHub/portunid_particle_tracking/BRAN_2020/AUS/Ocean_'+product+'_'+str(years)+'_05.nc')

# June
#for product in products:
for year in years:
            url =("https://dapds00.nci.org.au/thredds/ncss/gb6/BRAN/BRAN2020/daily/ocean_"+product+"_"+str(year)+"_06.nc?var="+product+"&north=-8&west=142&east=161&south=-46&disableProjSubset=on&horizStride=1&time_start="+str(year)+"-06-01T12%3A00%3A00Z&time_end="+str(year)+"-06-30T12%3A00%3A00Z&timeStride=1&vertCoord=2.5&addLatLon=true")
            wget.download(url, '../../srv/scratch/z3374139/BRAN_AUS/Charlie/Ocean_'+product+'_'+str(year)+'_06.nc')
            #wget.download(url, '/Users/htsch/Documents/GitHub/portunid_particle_tracking/BRAN_2020/AUS/Ocean_'+product+'_'+str(years)+'_06.nc')

# July
#for product in products:
for year in years:
            url =("https://dapds00.nci.org.au/thredds/ncss/gb6/BRAN/BRAN2020/daily/ocean_"+product+"_"+str(year)+"_07.nc?var="+product+"&north=-8&west=142&east=161&south=-46&disableProjSubset=on&horizStride=1&time_start="+str(year)+"-07-01T12%3A00%3A00Z&time_end="+str(year)+"-07-31T12%3A00%3A00Z&timeStride=1&vertCoord=2.5&addLatLon=true")
            wget.download(url, '../../srv/scratch/z3374139/BRAN_AUS/Charlie/Ocean_'+product+'_'+str(year)+'_07.nc')
            #wget.download(url, '/Users/htsch/Documents/GitHub/portunid_particle_tracking/BRAN_2020/AUS/Ocean_'+product+'_'+str(years)+'_07.nc')

# August
#for product in products:
for year in years:
            url =("https://dapds00.nci.org.au/thredds/ncss/gb6/BRAN/BRAN2020/daily/ocean_"+product+"_"+str(year)+"_08.nc?var="+product+"&north=-8&west=142&east=161&south=-46&disableProjSubset=on&horizStride=1&time_start="+str(year)+"-08-01T12%3A00%3A00Z&time_end="+str(year)+"-08-31T12%3A00%3A00Z&timeStride=1&vertCoord=2.5&addLatLon=true")
            wget.download(url, '../../srv/scratch/z3374139/BRAN_AUS/Charlie/Ocean_'+product+'_'+str(year)+'_08.nc')
            #wget.download(url, '/Users/htsch/Documents/GitHub/portunid_particle_tracking/BRAN_2020/AUS/Ocean_'+product+'_'+str(years)+'_08.nc')
    
    # September
    #for product in products:
for year in years:
            url =("https://dapds00.nci.org.au/thredds/ncss/gb6/BRAN/BRAN2020/daily/ocean_"+product+"_"+str(year)+"_09.nc?var="+product+"&north=-8&west=142&east=161&south=-46&disableProjSubset=on&horizStride=1&time_start="+str(year)+"-09-01T12%3A00%3A00Z&time_end="+str(year)+"-09-30T12%3A00%3A00Z&timeStride=1&vertCoord=2.5&addLatLon=true")
            wget.download(url, '../../srv/scratch/z3374139/BRAN_AUS/Charlie/Ocean_'+product+'_'+str(year)+'_09.nc')
           # wget.download(url, '/Users/htsch/Documents/GitHub/portunid_particle_tracking/BRAN_2020/AUS/Ocean_'+product+'_'+str(years)+'_09.nc')

# October
#for product in products:
for year in years:
            url =("https://dapds00.nci.org.au/thredds/ncss/gb6/BRAN/BRAN2020/daily/ocean_"+product+"_"+str(year)+"_10.nc?var="+product+"&north=-8&west=142&east=161&south=-46&disableProjSubset=on&horizStride=1&time_start="+str(year)+"-10-01T12%3A00%3A00Z&time_end="+str(year)+"-10-31T12%3A00%3A00Z&timeStride=1&vertCoord=2.5&addLatLon=true")
            wget.download(url, '../../srv/scratch/z3374139/BRAN_AUS/Charlie/Ocean_'+product+'_'+str(year)+'_10.nc')
            #wget.download(url, '/Users/htsch/Documents/GitHub/portunid_particle_tracking/BRAN_2020/AUS/Ocean_'+product+'_'+str(years)+'_10.nc')
  
# November
#for product in products:
for year in years:
            url =("https://dapds00.nci.org.au/thredds/ncss/gb6/BRAN/BRAN2020/daily/ocean_"+product+"_"+str(year)+"_11.nc?var="+product+"&north=-8&west=142&east=161&south=-46&disableProjSubset=on&horizStride=1&time_start="+str(year)+"-11-01T12%3A00%3A00Z&time_end="+str(year)+"-11-30T12%3A00%3A00Z&timeStride=1&vertCoord=2.5&addLatLon=true")
            wget.download(url, '../../srv/scratch/z3374139/BRAN_AUS/Charlie/Ocean_'+product+'_'+str(year)+'_11.nc')
            #wget.download(url, '/Users/htsch/Documents/GitHub/portunid_particle_tracking/BRAN_2020/AUS/Ocean_'+product+'_'+str(years)+'_11.nc')
    
# December
#for product in products:
for year in years:
            url =("https://dapds00.nci.org.au/thredds/ncss/gb6/BRAN/BRAN2020/daily/ocean_"+product+"_"+str(year)+"_12.nc?var="+product+"&north=-8&west=142&east=161&south=-46&disableProjSubset=on&horizStride=1&time_start="+str(year)+"-12-01T12%3A00%3A00Z&time_end="+str(year)+"-12-31T12%3A00%3A00Z&timeStride=1&vertCoord=2.5&addLatLon=true")
            wget.download(url, '../../srv/scratch/z3374139/BRAN_AUS/Charlie/Ocean_'+product+'_'+str(year)+'_12.nc')
            #wget.download(url, '/Users/htsch/Documents/GitHub/portunid_particle_tracking/BRAN_2020/AUS/Ocean_'+product+'_'+str(years)+'_12.nc')
...
#for product in products: # note changed year to years
for year in years:
            url =("https://dapds00.nci.org.au/thredds/ncss/gb6/BRAN/BRAN2020/daily/ocean_"+product+"_"+str(year)+"_02.nc?var="+product+"&north=-8&west=142&east=161&south=-46&disableProjSubset=on&horizStride=1&time_start="+str(year)+"-02-01T12%3A00%3A00Z&time_end="+str(year)+"-02-28T12%3A00%3A00Z&timeStride=1&vertCoord=2.5&addLatLon=true")
            wget.download(url, '../../srv/scratch/z3374139/BRAN_AUS/Charlie/Ocean_'+product+'_'+str(year)+'_02.nc')
            #wget.download(url, '/Users/htsch/Documents/GitHub/portunid_particle_tracking/BRAN_2020/AUS/Ocean_'+product+'_'+str(years)+'_02.nc')
...
#for product in products:
for year in years:
            url =("https://dapds00.nci.org.au/thredds/ncss/gb6/BRAN/BRAN2020/daily/ocean_"+product+"_"+str(year)+"_02.nc?var="+product+"&north=-8&west=142&east=161&south=-46&disableProjSubset=on&horizStride=1&time_start="+str(year)+"-02-01T12%3A00%3A00Z&time_end="+str(year)+"-02-29T12%3A00%3A00Z&timeStride=1&vertCoord=2.5&addLatLon=true")
            wget.download(url, '../../srv/scratch/z3374139/BRAN_AUS/Charlie/Ocean_'+product+'_'+str(year)+'_02.nc')
            #wget.download(url, '/Users/htsch/Documents/GitHub/portunid_particle_tracking/BRAN_2020/AUS/Ocean_'+product+'_'+str(years)+'_02.nc')
