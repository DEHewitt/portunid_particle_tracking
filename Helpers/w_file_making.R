...
#===========================================================================
file_path <- "/srv/scratch/z5278054/portunid_particle_tracking/ozroms/"

file_list <- list.files(path = "/srv/scratch/z5278054/portunid_particle_tracking/ozroms", pattern = ".nc")
library(ncdf4)
...
#---------------------------------------------------
ncid_old <- nc_open(paste(file_path, file_list[i], sep = ""), write = T) # open the files
#ncid_old
