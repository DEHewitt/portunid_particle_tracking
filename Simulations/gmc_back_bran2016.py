...
filenames = {'U': sorted(glob('/srv/scratch/z5278054/BRAN_AUS/BRAN_2016/Ocean_u_*')), 
             'V': sorted(glob('/srv/scratch/z5278054/BRAN_AUS/BRAN_2016/Ocean_v_*')),
             'temp': sorted(glob('/srv/scratch/z5278054/BRAN_AUS/BRAN_2016/Ocean_temp_*')),
             'bathy': '/srv/scratch/z5278054/BRAN_AUS/BRAN_2016/grid_spec.nc',
             'salt': sorted(glob('/srv/scratch/z5278054/BRAN_AUS/BRAN_2016/Ocean_salt_*'))}
...
# Where to save
out_file = str(out_dir)+'/'+str(year_array[array_ref])+'_BRAN2016_Back.nc' # be sure to change naming for back/forawrd runs
